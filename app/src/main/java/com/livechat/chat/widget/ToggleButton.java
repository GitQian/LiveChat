...
import com.livechat.chat.utils.SimpleSpringListener;
import com.livechat.chat.utils.Spring;
import com.livechat.chat.utils.SpringConfig;
import com.livechat.chat.utils.SpringSystem;
import com.livechat.chat.utils.SpringUtil;
...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    private int onColor = Color.parseColor("#4ED964");
    /**
     * 关闭颜色
     */
    ...
    private void takeEffect(boolean animate) {
        ...
        } else {// 这里没有调用spring，所以spring里的当前值没有变更，这里要设置一下，同步两边的当前值
