...
public class CircleImageView extends ImageView {
    ...
    public CircleImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        border_width = a.getDimensionPixelSize(R.styleable.CircleImageView_border_width, default_border_width);
        border_color = a.getColor(R.styleable.CircleImageView_border_color, default_border_color);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 获取缩放后的图片
        Bitmap dest = Bitmap.createBitmap(bm, 0, 0, bm.getWidth(), bm.getHeight(), matrix, true);
        // 创建一个图层，在图层上演示图形混合后的效果, 不新建图层绘制的话会产生黑色背景
